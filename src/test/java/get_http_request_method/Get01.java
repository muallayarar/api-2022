...
public class Get01 {
    ...
    public void get01(){
        ...
        //3)Type automation script to send GET request--type the code to send request and the Response
        ...
        You will not get any error messages about second , third etc. errors
        That kind of assertions are called "Hard Assertion"
        Do we have Soft Assertion? yes
        In Soft Assertion(Verification), all codes will be executed and you will get report for all assertion
